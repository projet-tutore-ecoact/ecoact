# Documentation - Implémentation de l'Authentification
...
- `verifyPassword(String password, String storedPassword)` - Vérifie le mot de passe
...
- Entrée email/password/confirmPassword
- Validation complète
- Vérification si l'email existe
- Hachage sécurisé du password
- Gestion des erreurs
- Lien vers connexion
...
- `loginFragment` (Accueil)
  - → `registerFragment` (Créer un compte)
  - → `homeFragment` (Après connexion)

### Après authentification
- `homeFragment` (Accueil principal)
- `habitsFragment` (Habitudes)
- `devicesFragment` (Appareils)
...
1. **BCrypt** - Remplacer SHA-256 par BCrypt pour plus de sécurité
2. **Forgot Password** - Ajouter réinitialisation de mot de passe
...
7. **Offline Mode** - Permettre l'accès offline si déjà connecté
8. **Password Reset** - Récupération de compte oublié
...
### Fichiers importants
- `GUIDE_MIGRATIONS_ROOM.md` - Explique la migration BD
- `EXAMPLE_MIGRATION_COMPLETE.md` - Exemple de migration
- `MIGRATION_QUICK_REFERENCE.md` - Référence rapide migrations
...
✅ Entity User avec email/password
✅ Migration BD v1→v2
✅ UserDao avec findByEmail
✅ UserRepository avec insertUser
✅ SessionManager pour gestion session
✅ PasswordUtils pour hachage
✅ LoginFragment avec validation
✅ RegisterFragment avec validation
✅ Layout fragment_login
✅ Layout fragment_register
✅ Navigation graph avec authentification
✅ MainActivity avec gestion bottom_nav
✅ Strings localisées
✅ Design cohérent avec couleurs existantes
